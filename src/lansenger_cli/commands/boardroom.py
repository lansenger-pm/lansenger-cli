...
def reserve(
    ...
    leader_attend: str = typer.Option("", "--leader-attend", help="Leader attendance: 0=attend, 1=not attend"),
    ...
    other_demand: str = typer.Option("", "--other-demand", help="Other meeting requirements"),
    table_cards: str = typer.Option("", "--table-cards", help="Table cards: 0=on, 1=off"),
    ...
    result = client.reserve_boardroom(
        ...
        leader_attend=leader_attend, is_video=is_video, video_name=video_name,
        other_demand=other_demand, table_cards=table_cards,
